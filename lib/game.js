...
function newPreset2Grid(rows, cols, callback) {
    ...
    for (let r=0; r<rows; ++r){
        ...
        for (let c=0; c<cols; ++c){
            ...
            // preset conditional for alive cells
            if (r == 4 && c == 5 || r == 4 && c == 6 || r == 4 && c == 7 || r == 4 && c == 8 ||
                r == 4 && c == 9 || r == 4 && c == 10 || r == 4 && c == 11 || r == 4 && c == 12 ||
                r == 5 && c == 5 || r == 5 && c == 7 || r == 5 && c == 8 || r == 5 && c == 9 ||
                r == 5 && c == 10 || r == 5 && c == 12 || r == 6 && c == 5 || r == 6 && c == 6 ||
                r == 6 && c == 7 || r == 6 && c == 8 || r == 6 && c == 9 || r == 6 && c == 10 ||
                r == 6 && c == 11 || r == 6 && c == 12) {
                  cell.setAttribute('alive', 'true');
                } else {
                  cell.setAttribute('alive', 'false');
